...
public class ScoreAmp extends Command{
  ...
  public void initialize() {
    ...
    m_shooterSubsystem.setAmpVelocity(Constants.Shooter.ScoreAmpVelocity);
  }
  ...
  public void execute() {
    ...
    if ( m_shooterSubsystem.isAtLaunchVelocity(Constants.Shooter.launchVelocity, Constants.Shooter.AmpVelocityTolerance)) {
  ...
  public void end(boolean interrupted) {
    ...
    m_shooterSubsystem.setFeedVelocity(0);
    m_shooterSubsystem.setAmpVelocity(0);
