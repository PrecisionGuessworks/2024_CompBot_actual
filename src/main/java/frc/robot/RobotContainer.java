...
public class RobotContainer {
  ...
  ShotDistTable shotTable = new ShotDistTable();
...
/*  enable for testing once    */
  ...
  public RobotContainer() {
    ...
    robotCommands.put("AutoAimPID", new AutoAimPID(drivetrain, aprilCam, drive, arm, shooter, intake, joystick, shotTable)).withTimeout(2.6);
