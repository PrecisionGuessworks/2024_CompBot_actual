...
public class RobotContainer {
  ...
  Transform3d robotToCam = new Transform3d(new Translation3d(Units.inchesToMeters(0), Units.inchesToMeters(0.44), Units.inchesToMeters(0.37)), new Rotation3d(0,Units.degreesToRadians(15),0));
  Transform3d camToRobot = new Transform3d(new Translation3d(Units.inchesToMeters(0), Units.inchesToMeters(-0.44), Units.inchesToMeters(-0.37)), new Rotation3d(0,Units.degreesToRadians(-15),0));
...
/*  enable for testing once    */
  ...
  private void configureBindings() {
    ...
    operatorRightTrigger.whileTrue(new AutoAimPose(drivetrain, aprilCam, arm, shooter, robotToCam, drive, joystick));
