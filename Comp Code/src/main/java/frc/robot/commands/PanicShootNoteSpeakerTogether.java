...
public class PanicShootNoteSpeakerTogether extends Command {
  ...
  public PanicShootNoteSpeakerTogether(ShooterSubsystem shooterSubsystem, ArmSubsystem armSubsystem,
  ...
  public void execute() {
    ...
    if (m_shooterSubsystem.isAtLaunchVelocity(Constants.Shooter.launchVelocity,
        Constants.Shooter.launchVelocityTolerance)
        && m_armSubsystem.isAtAngle(Constants.Arm.launchAngle, Constants.Arm.launchAngleTolerance)) {
