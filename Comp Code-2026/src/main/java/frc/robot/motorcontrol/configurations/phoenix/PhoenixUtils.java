...
public class PhoenixUtils {
  ...
  public static boolean CANcoderConfigsEqual(
    ...
    if (!(expected.MagnetSensor.AbsoluteSensorDiscontinuityPoint == actual.MagnetSensor.AbsoluteSensorDiscontinuityPoint)) {
      DriverStation.reportWarning(
          "[AbsoluteSensorRange] Expected: "
              + expected.MagnetSensor.AbsoluteSensorDiscontinuityPoint
              + ", Actual: "
              + actual.MagnetSensor.AbsoluteSensorDiscontinuityPoint,
          false);
      return false;
    }
    return true;
